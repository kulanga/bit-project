...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8">
            ...
            <form role="form" name="manage_ac_user_form" method="post" action="/admin/course/new">
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        <label for="no_of_semesters">Start Date <span class="required">*</span></label>
                        <input type="text" class="form-control col-md-3" id="start_date" name="start_date" value="<?php echo set_value('course_code', is_object($course) ? $course->start_date : '')?>" required/>
                    </div>
                </div>
